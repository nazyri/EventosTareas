...
function mostrarEventos() {
    ...
    eventos.forEach((evento, index) => {
        ...
        elementoLista.innerHTML = `<strong>${evento.nombre}</strong><br>${evento.descripcion}<br>Fecha de entrega: ${evento.fecha}`;
...
function mostrarTareas() {
    ...
    tareas.forEach((tarea, index) => {
        ...
        elementoTarea.innerHTML = `<strong>${tarea.nombre}</strong><br>${tarea.descripcion}<br>Fecha de entrega: ${tarea.fecha}`;
